            ...
            <div className="about--section--box">
                <div className="hero--section--content">
                    ...
                    <p className="hero--section-description">
                        Currently in my final year at EMSI Marrakesh, where I have been diligently expanding my
                    ...
                    <p className="hero--section-description">
                        ...
                        tutor at the same center,
                        where I contribute to fostering a strong understanding of programming concepts among the
                        students. In these roles,
